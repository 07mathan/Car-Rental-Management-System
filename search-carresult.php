...
$brand=$_POST['brand'];
$On Roadtype=$_POST['On Roadtype'];
$sql = "SELECT id from tblvehicles where tblvehicles.VehiclesBrand=:brand and tblvehicles.On RoadType=:On Roadtype";
$query = $dbh -> prepare($sql);
$query -> bindParam(':brand',$brand, PDO::PARAM_STR);
$query -> bindParam(':On Roadtype',$On Roadtype, PDO::PARAM_STR);
$query->execute();
...
$sql = "SELECT tblvehicles.*,tblbrands.BrandName,tblbrands.id as bid  from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand where tblvehicles.VehiclesBrand=:brand and tblvehicles.On RoadType=:On Roadtype";
$query = $dbh -> prepare($sql);
$query -> bindParam(':brand',$brand, PDO::PARAM_STR);
$query -> bindParam(':On Roadtype',$On Roadtype, PDO::PARAM_STR);
$query->execute();
        ...
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <ul>
              ...
              <li><i class="fa fa-car" aria-hidden="true"></i><?php echo htmlentities($result->On RoadType);?></li>
            </ul>
...
<?php }} ?>
              ...
              <div class="form-group select">
                <select class="form-control">
                  <option>Select On Road Type</option>
